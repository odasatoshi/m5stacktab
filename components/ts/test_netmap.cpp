...
void test_pick_endpoint()
{
    ...
    const std::vector<std::string> real = {"203.0.113.1:41642", "192.168.0.57:41642",
    ...
    CHECK(ts::pick_endpoint(real, 0, 0) == "203.0.113.1:41642");
    CHECK(ts::pick_endpoint(real, me, 0) == "203.0.113.1:41642");
